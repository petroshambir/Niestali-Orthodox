...
//           className="w-full mt-8 bg-blue-600 text-white py-3 rounded-lg font-semibold hover:bg-blue-700 transition disabled:opacity-60"
//         >
//           {loading
//             ? 'Registering...'
//             : 'Register Student'}
...
//                 onChange={handleChange}
//                 required
//                 className="w-full border border-slate-300 rounded-lg px-4 py-3 pr-12 outline-none focus:ring-2 focus:ring-blue-500"
//               />
...
//                 }
//                 className="absolute right-3 top-1/2 -translate-y-1/2 text-slate-500 hover:text-blue-600 transition text-lg"
//                 aria-label={
//                   showPassword
//                     ? 'Hide password'
//                     : 'Show password'
